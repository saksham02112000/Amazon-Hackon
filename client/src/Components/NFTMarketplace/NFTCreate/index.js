...
import {marketplaceAddress as marketplaceAddressL} from "../../marketplaceAddress";
...
const NFTMarketplace = () => {
    ...
    async function listNFTForSale() {
        const marketplaceAddress = marketplaceAddressL;
        ...
        let contract = new ethers.Contract(marketplaceAddress, NFTMarketplaceABI.abi, signer)
